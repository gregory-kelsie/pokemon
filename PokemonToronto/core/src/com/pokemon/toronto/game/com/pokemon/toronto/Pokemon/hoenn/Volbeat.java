...
public class Volbeat extends Pokemon {
    ...
    public static final int NUMBER = 313;
    public static final String NAME = "Volbeat";
    public static final String TYPE_OF_POKEMON = "Firefly";
    public static final String DESCRIPTION = "It communicates with others by lighting up its " +
            "rear at night. It loves Illumise's sweet aroma.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/volbeat.png";
    public static final String BACK_PATH = "battle/backs/hoenn/volbeat.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/volbeat.png";
    public static final String CRY_PATH = "sounds/cry/313.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/volbeat.png";
    ...
    /**
     * Init volbeat's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        levelUpSkills.put(8, new ArrayList<Integer>(Arrays.asList(SkillFactory.CONFUSE_RAY)));
        ...
        levelUpSkills.put(22, new ArrayList<Integer>(Arrays.asList(SkillFactory.TAIL_GLOW)));
        levelUpSkills.put(26, new ArrayList<Integer>(Arrays.asList(SkillFactory.SIGNAL_BEAM)));
        //29 PROTECT
