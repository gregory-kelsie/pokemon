...
public class HyperBeam extends DamageSkill {
    /**
     * - Name: Hyper Beam
     * - Type: Normal
     * - Base Damage: 150
     ...
     */
    public HyperBeam() {
        super(SkillFactory.HYPER_BEAM, "Hyper Beam", SkillDescription.HYPER_BEAM, 5,
                Pokemon.Type.NORMAL, SkillCategory.SPECIAL, 90, 150, 1);
    }
