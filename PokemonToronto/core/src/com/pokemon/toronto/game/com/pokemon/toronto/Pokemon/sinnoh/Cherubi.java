...
public class Cherubi extends Pokemon {
    ...
    private static final int NUMBER = 420;
    private static final String NAME = "Cherubi";
    ...
    private static final int BASE_SPECIAL_DEFENSE = 53;
    private static final int BASE_SPEED = 35;

    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/sinnoh/cherubi.png";
    private static final String BACK_PATH = "battle/backs/sinnoh/cherubi.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/cherubi.png";
    private static final String CRY_PATH = "sounds/cry/420.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/cherubi.png";
