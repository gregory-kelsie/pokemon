...
public class Greninja extends Pokemon {
    ...
    public static final int NUMBER = 658;
    public static final String NAME = "Greninja";
    public static final String TYPE_OF_POKEMON = "Ninja";
    public static final String DESCRIPTION = "It creates throwing stars out of compressed water." +
            " When it spins them and throws them at high speed, these stars can split metal in " +
            "two.";
    ...
    public static final int BASE_SPEED = 122;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/kalos/greninja.png";
    public static final String BACK_PATH = "battle/backs/kalos/greninja.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/kalos/greninja.png";
    public static final String CRY_PATH = "sounds/cry/658.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kalos/greninja.png";
