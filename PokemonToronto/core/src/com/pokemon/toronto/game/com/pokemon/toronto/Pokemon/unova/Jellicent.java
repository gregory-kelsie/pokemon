...
public class Jellicent extends Pokemon {
    ...
    private static final int NUMBER = 593;
    private static final String NAME = "Jellicent";
    ...
    private static final Ability SECOND_ABILITY = new Ability.CursedBody();
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/jellicent.png";
    private static final String BACK_PATH = "battle/backs/unova/jellicent.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/jellicent.png";
    private static final String CRY_PATH = "sounds/cry/593.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/jellicent.png";
