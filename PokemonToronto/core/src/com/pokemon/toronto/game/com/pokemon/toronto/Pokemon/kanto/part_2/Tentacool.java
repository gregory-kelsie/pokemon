...
public class Tentacool extends Pokemon {
    ...
    /**
     * Create a Tentacool with the specified level.
     * @param level The level of the Tentacool.
     */
    ...
    /**
     * Create an Tentacool from the database.
     ...
     */
    public Tentacool(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
