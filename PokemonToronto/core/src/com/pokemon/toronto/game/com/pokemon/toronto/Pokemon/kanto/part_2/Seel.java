...
public class Seel extends Pokemon {
    ...
    /**
     * Create a Seel with the specified level.
     * @param level The level of the Seel.
     */
    public Seel(int level) {
        super(NUMBER, NAME, level, Type.WATER, Type.NONE, Ability.THICK_FAT, ExpType.MEDIUM_FAST,
    ...
    /**
     * Create an Seel from the database.
     ...
     */
    public Seel(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
