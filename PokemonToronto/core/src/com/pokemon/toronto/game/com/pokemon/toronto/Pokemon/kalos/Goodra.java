...
public class Goodra extends Pokemon {
    ...
    private static final int NUMBER = 706;
    private static final String NAME = "Goodra";
    private static final int BASE_EXP = 270;
    private static final int[] EV_YIELD = {0, 0, 0, 0, 3, 0};
    private static final int CAPTURE_RATE = 45;
    private static final double WEIGHT = 150.5;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/kalos/goodra.png";
    private static final String BACK_PATH = "battle/backs/kalos/goodra.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/kalos/goodra.png";
    private static final String CRY_PATH = "sounds/cry/706.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/kalos/goodra.png";
