...
public class Synthesis extends Skill {
     ...
     */
    public Synthesis() {
        super(SkillFactory.SYNTHESIS, "Synthesis", SkillDescription.SYNTHESIS, 5,
                Pokemon.Type.GRASS, Skill.SkillCategory.MISC, 100);
        targetsEnemy = false;
    }

    /**
     * Use Synthesis and return the move results.
     * Sets the weather to Synthesis.
    ...
    /**
     * Return Synthesis's skill animation.
