...
public class Galvantula extends Pokemon {
    ...
    private static final int NUMBER = 596;
    private static final String NAME = "Galvantula";
    private static final int BASE_EXP = 165;
    private static final int[] EV_YIELD = {0, 0, 0, 0, 0, 2};
    private static final int CAPTURE_RATE = 75;
    private static final double WEIGHT = 14.3;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/galvantula.png";
    private static final String BACK_PATH = "battle/backs/unova/galvantula.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/galvantula.png";
    private static final String CRY_PATH = "sounds/cry/596.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/galvantula.png";
