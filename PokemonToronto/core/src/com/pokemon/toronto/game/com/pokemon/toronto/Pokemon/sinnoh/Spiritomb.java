...
public class Spiritomb extends Pokemon {
    ...
    private static final int NUMBER = 442;
    private static final String NAME = "Spiritomb";
    ...
    private static final int BASE_DEFENSE = 108;
    private static final int BASE_SPECIAL_ATTACK = 92;
    private static final int BASE_SPECIAL_DEFENSE = 108;
    private static final int BASE_SPEED = 35;

    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/sinnoh/spiritomb.png";
    private static final String BACK_PATH = "battle/backs/sinnoh/spiritomb.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/spiritomb.png";
    private static final String CRY_PATH = "sounds/cry/442.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/spiritomb.png";
