...
public class Sigilyph extends Pokemon {
    ...
    public static final int NUMBER = 561;
    public static final String NAME = "Sigilyph";
    public static final String TYPE_OF_POKEMON = "Avianoid";
    public static final String DESCRIPTION = "They never vary the route they fly, because their" +
            " memories of guarding an ancient city remain steadfast.";
    ...
    public static final Ability FIRST_ABILITY = new Ability.WonderSkin();
    ...
    public static final int BASE_SPECIAL_ATTACK = 103;
    public static final int BASE_SPECIAL_DEFENSE = 80;
    public static final int BASE_SPEED = 97;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/sigilyph.png";
    public static final String BACK_PATH = "battle/backs/unova/sigilyph.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/sigilyph.png";
    public static final String CRY_PATH = "sounds/cry/561.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/sigilyph.png";
