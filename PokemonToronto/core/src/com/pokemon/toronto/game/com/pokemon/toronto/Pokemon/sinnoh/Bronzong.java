...
public class Bronzong extends Pokemon {
    ...
    private static final int NUMBER = 437;
    private static final String NAME = "Bronzong";
    ...
    private static final double WEIGHT = 187;
    ...
    private static final int BASE_DEFENSE = 116;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/sinnoh/bronzong.png";
    private static final String BACK_PATH = "battle/backs/sinnoh/bronzong.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/bronzong.png";
    private static final String CRY_PATH = "sounds/cry/437.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/bronzong.png";
