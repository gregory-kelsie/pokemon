...
public class Plusle extends Pokemon {
    ...
    public static final int NUMBER = 311;
    public static final String NAME = "Plusle";
    public static final String TYPE_OF_POKEMON = "Cheering";
    public static final String DESCRIPTION = "It cheers on friends with pom-poms made of sparks." +
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/plusle.png";
    public static final String BACK_PATH = "battle/backs/hoenn/plusle.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/plusle.png";
    public static final String CRY_PATH = "sounds/cry/311.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/plusle.png";
