...
public class Golisopod extends Pokemon {
    ...
    public static final String NAME = "Golisopod";
    public static final String TYPE_OF_POKEMON = "Hard Scale";
    public static final String DESCRIPTION = "The shell covering its body is as hard as diamond." +
            " This Pokémon will do anything it takes to win.";
    ...
    public static final Ability FIRST_ABILITY = new Ability.EmergencyExit();
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/alola/golisopod.png";
    public static final String BACK_PATH = "battle/backs/alola/golisopod.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/alola/golisopod.png";
    public static final String CRY_PATH = "sounds/cry/768.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/alola/golisopod.png";
