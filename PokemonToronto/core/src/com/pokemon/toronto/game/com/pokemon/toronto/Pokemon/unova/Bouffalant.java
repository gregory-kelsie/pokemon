...
public class Bouffalant extends Pokemon {
    ...
    private static final int NUMBER = 626;
    private static final String NAME = "Bouffalant";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/bouffalant.png";
    private static final String BACK_PATH = "battle/backs/unova/bouffalant.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/bouffalant.png";
    private static final String CRY_PATH = "sounds/cry/626.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/bouffalant.png";
