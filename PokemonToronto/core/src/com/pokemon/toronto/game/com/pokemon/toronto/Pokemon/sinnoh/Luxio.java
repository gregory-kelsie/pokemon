...
public class Luxio extends Pokemon {
    ...
    public static final int NUMBER = 404;
    public static final String NAME = "Luxio";
    public static final String TYPE_OF_POKEMON = "Spark";
    public static final String DESCRIPTION = "Strong electricity courses through the tips of " +
            "its sharp claws. A light scratch causes fainting in foes.";
    ...
    public static final int BASE_DEFENSE = 49;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/sinnoh/luxio.png";
    public static final String BACK_PATH = "battle/backs/sinnoh/luxio.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/luxio.png";
    public static final String CRY_PATH = "sounds/cry/404.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/luxio.png";
