...
public class Furret extends Pokemon {
    ...
    public static final String NAME = "Furret";
    public static final String TYPE_OF_POKEMON = "Long Body";
    public static final String DESCRIPTION = "The mother puts its offspring to sleep by" +
            " curling up around them. It corners foes with speed.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/johto/furret.png";
    public static final String BACK_PATH = "battle/backs/johto/furret.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/johto/furret.png";
    public static final String CRY_PATH = "sounds/cry/162.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/johto/furret.png";
