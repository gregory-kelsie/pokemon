...
public class MorningSun extends Skill {
    /**
     * - Name: Morning Sun
     * - Type: Normal
     * - PP: 5
     ...
     */
    public MorningSun() {
        super(SkillFactory.MORNING_SUN, "Morning Sun", SkillDescription.MORNING_SUN, 5,
                Pokemon.Type.NORMAL, Skill.SkillCategory.MISC, -1);
        targetsEnemy = false;
    }

    /**
     * Use Morning Sun and return the move results.
     * Sets the weather to Morning Sun.
    ...
    public List<String> use(Pokemon skillUser, Pokemon enemyPokemon, int skillUserPartyPosition,
        ...
        if (field.getWeatherType() == WeatherType.SUN) {
            ...
            skillUser.addHealth((int)Math.round(skillUser.getHealthStat() * 0.125));
        }
    ...
    /**
     * Return Morning Sun's skill animation.
