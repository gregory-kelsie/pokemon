...
public class Sunflora extends Pokemon {
    ...
    public static final String NAME = "Sunflora";
    public static final String TYPE_OF_POKEMON = "Sun";
    public static final String DESCRIPTION = "It gets energy from warm sunlight and is known" +
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/johto/sunflora.png";
    public static final String BACK_PATH = "battle/backs/johto/sunflora.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/johto/sunflora.png";
    public static final String CRY_PATH = "sounds/cry/192.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/johto/sunflora.png";
