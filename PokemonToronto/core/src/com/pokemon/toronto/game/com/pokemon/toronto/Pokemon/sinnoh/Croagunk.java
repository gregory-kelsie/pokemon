...
public class Croagunk extends Pokemon {
    ...
    private static final int NUMBER = 453;
    private static final String NAME = "Croagunk";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/sinnoh/croagunk.png";
    private static final String BACK_PATH = "battle/backs/sinnoh/croagunk.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/croagunk.png";
    private static final String CRY_PATH = "sounds/cry/453.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/croagunk.png";
