...
public class Tepig extends Pokemon {
    ...
    private static final int NUMBER = 498;
    private static final String NAME = "Tepig";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/tepig.png";
    private static final String BACK_PATH = "battle/backs/unova/tepig.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/tepig.png";
    private static final String CRY_PATH = "sounds/cry/498.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/tepig.png";
