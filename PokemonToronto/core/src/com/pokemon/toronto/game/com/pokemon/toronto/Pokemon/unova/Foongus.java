...
public class Foongus extends Pokemon {
    ...
    public static final int NUMBER = 590;
    public static final String NAME = "Foongus";
    public static final String TYPE_OF_POKEMON = "Mushroom";
    public static final String DESCRIPTION = "It lures Pokémon with its pattern that looks just" +
            " like a Poké Ball then releases poison spores.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/foongus.png";
    public static final String BACK_PATH = "battle/backs/unova/foongus.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/foongus.png";
    public static final String CRY_PATH = "sounds/cry/590.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/foongus.png";
