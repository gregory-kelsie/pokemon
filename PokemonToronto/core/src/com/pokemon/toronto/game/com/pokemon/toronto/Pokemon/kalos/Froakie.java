...
public class Froakie extends Pokemon {
    ...
    public static final String NAME = "Froakie";
    public static final String TYPE_OF_POKEMON = "Bubble Frog";
    public static final String DESCRIPTION = "It secretes flexible bubbles from its chest and " +
            "back. The bubbles reduce the damage it would otherwise take when attacked.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/kalos/froakie.png";
    public static final String BACK_PATH = "battle/backs/kalos/froakie.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/kalos/froakie.png";
    public static final String CRY_PATH = "sounds/cry/656.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kalos/froakie.png";
