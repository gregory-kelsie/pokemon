...
public class Flamethrower extends SecondaryEffectSkill {
    /**
     * - Name: Flamethrower
     * - Type: Fire
     * - Base Damage: 90
     ...
     */
    public Flamethrower() {
        super(SkillFactory.FLAMETHROWER, "Flamethrower", SkillDescription.FLAMETHROWER, 15,
                Pokemon.Type.FIRE, SkillCategory.SPECIAL, 100, 90, 1, .1);
