...
public class Stoutland extends Pokemon {
    ...
    private static final int NUMBER = 508;
    private static final String NAME = "Stoutland";
    private static final int BASE_EXP = 225;
    private static final int[] EV_YIELD = {0, 3, 0, 0, 0, 0};
    private static final int CAPTURE_RATE = 45;
    private static final double WEIGHT = 61;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/stoutland.png";
    private static final String BACK_PATH = "battle/backs/unova/stoutland.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/stoutland.png";
    private static final String CRY_PATH = "sounds/cry/508.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/stoutland.png";
