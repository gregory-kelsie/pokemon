...
public class Primeape extends Pokemon {
    ...
    public static final String NAME = "Primeape";
    public static final String TYPE_OF_POKEMON = "Pig Monkey";
    public static final String DESCRIPTION = "It is always outrageously furious. If it gives" +
            " chase, it will tenaciously track the target no matter how far.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/primeape.png";
    public static final String BACK_PATH = "battle/backs/primeape.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/primeape.png";
    public static final String CRY_PATH = "sounds/cry/057.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kanto/057.png";
