...
public class Virizion extends Pokemon {
    ...
    public static final int NUMBER = 640;
    public static final String NAME = "Virizion";
    public static final String TYPE_OF_POKEMON = "Grassland";
    public static final String DESCRIPTION = "Its head sprouts horns as sharp as blades. Using" +
            " whirlwind-like movements, it confounds and swiftly cuts opponents.";
    ...
    public static final int BASE_SPECIAL_DEFENSE = 129;
    public static final int BASE_SPEED = 108;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/virizion.png";
    public static final String BACK_PATH = "battle/backs/unova/virizion.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/virizion.png";
    public static final String CRY_PATH = "sounds/cry/640.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/virizion.png";
    ...
    /**
     * Init virizion's level up skills.
     */
    @Override
