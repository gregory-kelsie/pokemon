...
public class Dwebble extends Pokemon {
    ...
    private static final int NUMBER = 557;
    private static final String NAME = "Dwebble";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/dwebble.png";
    private static final String BACK_PATH = "battle/backs/unova/dwebble.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/dwebble.png";
    private static final String CRY_PATH = "sounds/cry/557.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/dwebble.png";
