...
public class Steenee extends Pokemon {
    ...
    private static final int NUMBER = 762;
    private static final String NAME = "Steenee";
    private static final int BASE_EXP = 102;
    private static final int[] EV_YIELD = {0, 0, 0, 0, 0, 2};
    private static final int CAPTURE_RATE = 120;
    private static final double WEIGHT = 8.2;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/alola/steenee.png";
    private static final String BACK_PATH = "battle/backs/alola/steenee.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/alola/steenee.png";
    private static final String CRY_PATH = "sounds/cry/762.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/alola/steenee.png";
