...
public class AlolanRaticate extends Pokemon {
     ...
     */
    public AlolanRaticate(int level) {
        super(NUMBER, NAME, level, Type.DARK, Type.NORMAL, Ability.THICK_FAT, ExpType.MEDIUM_FAST,
     ...
     */
    public AlolanRaticate(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
                    Skill secondSkill, Skill thirdSkill, Skill fourthSkill, int currentHealth, int currentExp,
                    Pokemon.Status status, Nature nature, Pokemon.Ability ability) {
        super(NUMBER, NAME, level, gender, status, ivs, evs, Type.DARK, Type.NORMAL, ability, nature, Pokemon.ExpType.MEDIUM_FAST,
                BASE_EXP, EV_YIELD, new int[]{BASE_HEALTH, BASE_ATTACK, BASE_DEFENSE,
                        BASE_SPECIAL_ATTACK, BASE_SPECIAL_DEFENSE, BASE_SPEED}, ICON_PATH,
