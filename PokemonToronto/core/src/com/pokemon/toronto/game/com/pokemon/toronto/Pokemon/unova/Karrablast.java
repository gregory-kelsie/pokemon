...
public class Karrablast extends Pokemon {
    ...
    private static final int NUMBER = 588;
    private static final String NAME = "Karrablast";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/karrablast.png";
    private static final String BACK_PATH = "battle/backs/unova/karrablast.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/karrablast.png";
    private static final String CRY_PATH = "sounds/cry/588.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/karrablast.png";
