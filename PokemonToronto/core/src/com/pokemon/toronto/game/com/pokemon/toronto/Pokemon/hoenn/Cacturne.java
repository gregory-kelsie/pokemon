...
public class Cacturne extends Pokemon {
    ...
    public static final String NAME = "Cacturne";
    public static final String TYPE_OF_POKEMON = "Scarecrow";
    public static final String DESCRIPTION = "It becomes active at night, seeking prey that is" +
    ...
    public static final double WEIGHT = 77.4;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/cacturne.png";
    public static final String BACK_PATH = "battle/backs/hoenn/cacturne.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/cacturne.png";
    public static final String CRY_PATH = "sounds/cry/332.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/cacturne.png";
    ...
    /**
     * Init cacturne's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        levelUpSkills.put(35, new ArrayList<Integer>(Arrays.asList(SkillFactory.SUCKER_PUNCH)));
        ...
        levelUpSkills.put(49, new ArrayList<Integer>(Arrays.asList(SkillFactory.COTTON_SPORE)));
