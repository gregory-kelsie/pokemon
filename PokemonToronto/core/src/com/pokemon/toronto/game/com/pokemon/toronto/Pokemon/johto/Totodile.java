...
public class Totodile extends Pokemon {
    ...
    public static final String NAME = "Totodile";
    public static final String TYPE_OF_POKEMON = "Big Jaw";
    public static final String DESCRIPTION = "It has the habit of biting anything with its" +
            " developed jaws. Even its Trainer needs to be careful.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/johto/totodile.png";
    public static final String BACK_PATH = "battle/backs/johto/totodile.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/johto/totodile.png";
    public static final String CRY_PATH = "sounds/cry/158.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/johto/totodile.png";
