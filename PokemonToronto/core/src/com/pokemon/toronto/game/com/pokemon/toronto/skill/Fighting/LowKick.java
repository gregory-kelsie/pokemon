...
public class LowKick extends DamageSkill {
    /**
     * - Name: Low Kick
     * - Type: Fighting
     ...
     */
    public LowKick() {
        super(SkillFactory.LOW_KICK, "Low Kick", SkillDescription.LOW_KICK, 20,
                Pokemon.Type.FIGHTING, SkillCategory.PHYSICAL, 100, 1, 1);
    }
