...
public class Twister extends DamageSkill {
    /**
     * - Name: Twister
     * - Type: Dragon
     * - Base Damage: 40
     ...
     */
    public Twister() {
        super(SkillFactory.TWISTER, "Twister", SkillDescription.TWISTER, 20, Pokemon.Type.DRAGON,
                Skill.SkillCategory.SPECIAL, 100, 40, 1);
    ...
    public List<String> use(Pokemon skillUser, Pokemon enemyPokemon, int skillUserPartyPosition,
        ...
        if (enemyPokemon.isFlying()) { //Double damage if enemy is flying with the move Fly.
            damage *= 2;
            ...
            damage = 40; // Reset damage back to normal.
            return results;
        } else {
