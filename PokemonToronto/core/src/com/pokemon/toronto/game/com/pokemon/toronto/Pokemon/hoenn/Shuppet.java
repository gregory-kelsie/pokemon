...
public class Shuppet extends Pokemon {
    ...
    public static final String NAME = "Shuppet";
    public static final String TYPE_OF_POKEMON = "Puppet";
    public static final String DESCRIPTION = "It loves vengeful emotions and hangs in rows under" +
    ...
    public static final int BASE_SPECIAL_DEFENSE = 33;
    public static final int BASE_SPEED = 45;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/shuppet.png";
    public static final String BACK_PATH = "battle/backs/hoenn/shuppet.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/shuppet.png";
    public static final String CRY_PATH = "sounds/cry/353.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/shuppet.png";
    ...
    /**
     * Init shuppet's level up skills.
     */
    @Override
    ...
    /* Return Banette if the shuppet is above level 37.
     * @return Banette if shuppet is the right level.
     */
    @Override
    public int getLevelUpEvolutionId() {
        if (level >= 37) {
            return PokemonId.BANETTE.getValue();
        }
        return -1;
    }
}
