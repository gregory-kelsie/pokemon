...
public class AlolanVulpix extends Pokemon {
    ...
    public AlolanVulpix(int level) {
        super(NUMBER, NAME, level, Pokemon.Type.ICE, Pokemon.Type.NONE, Ability.SNOW_CLOAK, ExpType.MEDIUM_FAST,
    ...
    public AlolanVulpix(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
        ...
        super(NUMBER, NAME, level, gender, status, ivs, evs, Type.ICE, Pokemon.Type.NONE, ability, nature, ExpType.MEDIUM_FAST,
                BASE_EXP, EV_YIELD, new int[]{BASE_HEALTH, BASE_ATTACK, BASE_DEFENSE,
                        BASE_SPECIAL_ATTACK, BASE_SPECIAL_DEFENSE, BASE_SPEED}, ICON_PATH,
