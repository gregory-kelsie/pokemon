...
public class Salamence extends Pokemon {
    ...
    public static final String NAME = "Salamence";
    public static final String TYPE_OF_POKEMON = "Dragon";
    public static final String DESCRIPTION = "As a result of its long-held dream of flying, its" +
    ...
    public static final double WEIGHT = 102.6;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/salamence.png";
    public static final String BACK_PATH = "battle/backs/hoenn/salamence.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/salamence.png";
    public static final String CRY_PATH = "sounds/cry/373.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/salamence.png";
    ...
    /**
     * Init salamence's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        levelUpSkills.put(63, new ArrayList<Integer>(Arrays.asList(SkillFactory.DOUBLE_EDGE)));
        initEvolutionSkills();
    }

    @Override
    protected void initEvolutionSkills() {
        evolutionSkills.add(SkillFactory.FLY);
    }
