...
public class Barbaracle extends Pokemon {
    ...
    private static final int NUMBER = 689;
    private static final String NAME = "Barbaracle";
    private static final int BASE_EXP = 175;
    private static final int[] EV_YIELD = {0, 2, 0, 0, 0, 0};
    private static final int CAPTURE_RATE = 45;
    private static final double WEIGHT = 96;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/kalos/barbaracle.png";
    private static final String BACK_PATH = "battle/backs/kalos/barbaracle.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/kalos/barbaracle.png";
    private static final String CRY_PATH = "sounds/cry/689.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/kalos/barbaracle.png";
