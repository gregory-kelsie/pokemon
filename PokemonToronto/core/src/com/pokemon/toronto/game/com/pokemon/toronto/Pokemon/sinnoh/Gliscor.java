...
public class Gliscor extends Pokemon {
    ...
    private static final int NUMBER = 472;
    private static final String NAME = "Gliscor";
    private static final int BASE_EXP = 179;
    private static final int[] EV_YIELD = {0, 0, 2, 0, 0, 0};
    private static final int CAPTURE_RATE = 30;
    private static final double WEIGHT = 42.5;
    ...
    private static final Ability HIDDEN_ABILITY = new Ability.PoisonHeal();
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/sinnoh/gliscor.png";
    private static final String BACK_PATH = "battle/backs/sinnoh/gliscor.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/gliscor.png";
    private static final String CRY_PATH = "sounds/cry/472.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/gliscor.png";
