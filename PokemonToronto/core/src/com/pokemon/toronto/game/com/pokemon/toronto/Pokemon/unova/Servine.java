...
public class Servine extends Pokemon {
    ...
    public static final int NUMBER = 496;
    public static final String NAME = "Servine";
    public static final String TYPE_OF_POKEMON = "Grass Snake";
    public static final String DESCRIPTION = "It moves along the ground as if sliding. Its swift" +
            " movements befuddle its foes, and it then attacks with a vine whip.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/servine.png";
    public static final String BACK_PATH = "battle/backs/unova/servine.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/servine.png";
    public static final String CRY_PATH = "sounds/cry/496.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/servine.png";
