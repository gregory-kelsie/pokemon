...
public class AlolanMeowth extends Pokemon {
    ...
    private static final String PROFILE_PATH = "trainercard/alolan_kanto/alolanmeowth.png";

    /**
     * Create a Meowth with the specified level.
     * @param level The level of the Meowth.
     */
    public AlolanMeowth(int level) {
     ...
     */
    public AlolanMeowth(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
