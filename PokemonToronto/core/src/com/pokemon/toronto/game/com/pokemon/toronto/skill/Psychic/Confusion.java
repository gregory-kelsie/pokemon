...
public class Confusion extends SecondaryEffectSkill {
    /**
     * - Name: Confusion
     * - Type: Psychic
     * - Base Damage: 50
     ...
     */
    public Confusion() {
        super(SkillFactory.CONFUSION, "Confusion", SkillDescription.CONFUSION, 25,
                Pokemon.Type.PSYCHIC, SkillCategory.SPECIAL, 100, 50, 1, .1);
