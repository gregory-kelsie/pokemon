...
public class Ludicolo extends Pokemon {
    ...
    public static final String NAME = "Ludicolo";
    public static final String TYPE_OF_POKEMON = "Carefree";
    public static final String DESCRIPTION = "If it hears festive music, all its muscles fill" +
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/ludicolo.png";
    public static final String BACK_PATH = "battle/backs/hoenn/ludicolo.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/ludicolo.png";
    public static final String CRY_PATH = "sounds/cry/272.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/ludicolo.png";
    ...
    /**
     * Init ludicolo's level up skills.
     */
    @Override
