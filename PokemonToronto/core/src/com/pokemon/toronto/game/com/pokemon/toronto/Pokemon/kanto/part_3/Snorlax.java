...
public class Snorlax extends Pokemon {
    ...
    /**
     * Create a Snorlax with the specified level.
     * @param level The level of the Snorlax.
     */
    public Snorlax(int level) {
        super(NUMBER, NAME, level, Type.NORMAL, Type.NONE, Ability.THICK_FAT, ExpType.SLOW,
    ...
    /**
     * Create an Snorlax from the database.
     ...
     */
    public Snorlax(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
