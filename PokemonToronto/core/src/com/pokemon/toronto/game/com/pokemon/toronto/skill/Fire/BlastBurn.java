...
public class BlastBurn extends DamageSkill{
    /**
     * - Name: Blast Burn
     * - Type: Fire
     * - Base Damage: 150
     ...
     */
    public BlastBurn() {
        super(SkillFactory.BLAST_BURN, "Blast Burn", SkillDescription.BLAST_BURN, 5,
                Pokemon.Type.FIRE, Skill.SkillCategory.SPECIAL, 90, 150, 1);
    }
