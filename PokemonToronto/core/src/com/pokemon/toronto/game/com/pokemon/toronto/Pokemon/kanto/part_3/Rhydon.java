...
public class Rhydon extends Pokemon {
    ...
    public static final String NAME = "Rhydon";
    public static final String TYPE_OF_POKEMON = "Drill";
    public static final String DESCRIPTION = "It begins walking on its hind legs after" +
            " evolution. It can punch holes through boulders with its horn.";

    public static final int BASE_EXP = 204;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/rhydon.png";
    public static final String BACK_PATH = "battle/backs/rhydon.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/rhydon.png";
    public static final String CRY_PATH = "sounds/cry/112.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kanto/112.png";
    ...
    public int getMoonStoneEvolutionId() {
        return PokemonId.RHYPERIOR.getValue();
    }
}
