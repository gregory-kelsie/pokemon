...
public class Chikorita extends Pokemon {
    ...
    public static final String NAME = "Chikorita";
    public static final String TYPE_OF_POKEMON = "Leaf";
    public static final String DESCRIPTION = "It uses the leaf on its head to determine" +
            " the temperature and humidity. It loves to sunbathe.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/johto/chikorita.png";
    public static final String BACK_PATH = "battle/backs/johto/chikorita.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/johto/chikorita.png";
    public static final String CRY_PATH = "sounds/cry/152.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/johto/chikorita.png";
