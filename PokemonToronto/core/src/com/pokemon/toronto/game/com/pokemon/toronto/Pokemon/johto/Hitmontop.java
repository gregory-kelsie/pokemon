...
public class Hitmontop extends Pokemon {
    ...
    public static final String TYPE_OF_POKEMON = "Handstand";
    public static final String DESCRIPTION = "It fights while spinning like a top. The" +
            " centrifugal force boosts its destructive power by ten.";
