...
public class Poliwhirl extends Pokemon {
    ...
    /**
     * Create a Poliwhirl with the specified level.
     * @param level The level of the Poliwhirl.
     */
    ...
    /**
     * Create an Poliwhirl from the database.
     ...
     */
    public Poliwhirl(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
