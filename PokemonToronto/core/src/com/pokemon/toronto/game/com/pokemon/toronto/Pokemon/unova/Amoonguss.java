...
public class Amoonguss extends Pokemon {
    ...
    private static final int NUMBER = 591;
    private static final String NAME = "Amoonguss";
    ...
    //Base Stats
    private static final int BASE_HEALTH = 114;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/amoonguss.png";
    private static final String BACK_PATH = "battle/backs/unova/amoonguss.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/amoonguss.png";
    private static final String CRY_PATH = "sounds/cry/591.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/amoonguss.png";
