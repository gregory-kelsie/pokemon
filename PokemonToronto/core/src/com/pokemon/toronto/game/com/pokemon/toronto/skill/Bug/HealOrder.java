...
public class HealOrder extends Skill {
    /**
     * - Name: Heal Order
     * - Type: Bug
     * - PP: 10
     ...
     */
    public HealOrder() {
        super(SkillFactory.HEAL_ORDER, "Heal Order", 10, Pokemon.Type.BUG, Skill.SkillCategory.MISC, -1);
        targetsEnemy = false;
    }

    /**
     * Use Heal Order and return the move results.
     * Sets the weather to Heal Order.
    ...
    /**
     * Return Heal Order's skill animation.
