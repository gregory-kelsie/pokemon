...
public class Grumpig extends Pokemon {
    ...
    public static final String NAME = "Grumpig";
    public static final String TYPE_OF_POKEMON = "Manipulate";
    public static final String DESCRIPTION = "It uses black pearls to amplify its psycho-power." +
    ...
    public static final double WEIGHT = 71.5;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/grumpig.png";
    public static final String BACK_PATH = "battle/backs/hoenn/grumpig.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/grumpig.png";
    public static final String CRY_PATH = "sounds/cry/326.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/grumpig.png";
    ...
    /**
     * Init grumpig's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        earlySkills.add(SkillFactory.SNORE);
        levelUpSkills.put(35, earlySkills);
        levelUpSkills.put(42, new ArrayList<Integer>(Arrays.asList(SkillFactory.PSYSHOCK)));
        levelUpSkills.put(46, new ArrayList<Integer>(Arrays.asList(SkillFactory.PAYBACK)));
        levelUpSkills.put(52, new ArrayList<Integer>(Arrays.asList(SkillFactory.PSYCHIC)));
        levelUpSkills.put(60, new ArrayList<Integer>(Arrays.asList(SkillFactory.BOUNCE)));
        initEvolutionSkills();
    }

    @Override
    protected void initEvolutionSkills() {
        evolutionSkills.add(SkillFactory.TEETER_DANCE);
    }
