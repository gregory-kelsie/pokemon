...
public class Staravia extends Pokemon {
    ...
    public static final int NUMBER = 397;
    public static final String NAME = "Staravia";
    public static final String TYPE_OF_POKEMON = "Starling";
    public static final String DESCRIPTION = "Recognizing their own weakness, they always live in" +
            " a group. When alone, a Staravia cries noisily.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/sinnoh/staravia.png";
    public static final String BACK_PATH = "battle/backs/sinnoh/staravia.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/staravia.png";
    public static final String CRY_PATH = "sounds/cry/397.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/staravia.png";
