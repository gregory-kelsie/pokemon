...
public class Archen extends Pokemon {
    ...
    private static final int NUMBER = 566;
    private static final String NAME = "Archen";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/archen.png";
    private static final String BACK_PATH = "battle/backs/unova/archen.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/archen.png";
    private static final String CRY_PATH = "sounds/cry/566.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/archen.png";
