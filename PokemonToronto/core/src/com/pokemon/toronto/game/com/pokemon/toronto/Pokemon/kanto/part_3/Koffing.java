...
public class Koffing extends Pokemon {
    ...
    public static final String NAME = "Koffing";
    public static final String TYPE_OF_POKEMON = "Poison Gas";
    public static final String DESCRIPTION = "Its thin, filmy body is filled with gases that" +
            " cause constant sniffles, coughs and teary eyes.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/koffing.png";
    public static final String BACK_PATH = "battle/backs/koffing.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/koffing.png";
    public static final String CRY_PATH = "sounds/cry/109.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kanto/109.png";
