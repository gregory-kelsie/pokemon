...
public class Fennekin extends Pokemon {
    ...
    public static final String NAME = "Fennekin";
    public static final String TYPE_OF_POKEMON = "Fox";
    public static final String DESCRIPTION = "As it walks, it munches on a twig in place of a " +
            "snack. It intimidates opponents by puffing hot air out of its ears.";
    public static final double HEIGHT = 0.4;
    public static final int BASE_EXP = 61;
    public static final int[] EV_YIELD = {0, 0, 0, 1, 0, 0};
    public static final int CAPTURE_RATE = 45;
    public static final double WEIGHT = 9.4;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/kalos/fennekin.png";
    public static final String BACK_PATH = "battle/backs/kalos/fennekin.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/kalos/fennekin.png";
    public static final String CRY_PATH = "sounds/cry/653.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kalos/fennekin.png";
