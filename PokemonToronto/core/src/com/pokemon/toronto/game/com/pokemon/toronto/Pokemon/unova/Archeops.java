...
public class Archeops extends Pokemon {
    ...
    private static final int NUMBER = 567;
    private static final String NAME = "Archeops";
    private static final int BASE_EXP = 177;
    private static final int[] EV_YIELD = {0, 2, 0, 0, 0, 0};
    private static final int CAPTURE_RATE = 45;
    private static final double WEIGHT = 32;

    private static final Ability FIRST_ABILITY = new Ability.Defeatist();
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/archeops.png";
    private static final String BACK_PATH = "battle/backs/unova/archeops.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/archeops.png";
    private static final String CRY_PATH = "sounds/cry/567.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/archeops.png";
