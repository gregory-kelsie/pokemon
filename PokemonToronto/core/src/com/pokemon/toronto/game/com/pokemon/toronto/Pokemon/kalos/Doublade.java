...
public class Doublade extends Pokemon {
    ...
    private static final int NUMBER = 680;
    private static final String NAME = "Doublade";
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/kalos/doublade.png";
    private static final String BACK_PATH = "battle/backs/kalos/doublade.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/kalos/doublade.png";
    private static final String CRY_PATH = "sounds/cry/680.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/kalos/doublade.png";
