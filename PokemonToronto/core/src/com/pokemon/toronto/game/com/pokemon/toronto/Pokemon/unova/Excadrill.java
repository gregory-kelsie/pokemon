...
public class Excadrill extends Pokemon {
    ...
    public static final int NUMBER = 530;
    public static final String NAME = "Excadrill";
    public static final String TYPE_OF_POKEMON = "Subterrene";
    public static final String DESCRIPTION = "It can help in tunnel construction. Its drill has " +
            "evolved into steel strong enough to bore through iron plates.";
    public static final double HEIGHT = 0.7;
    public static final int BASE_EXP = 178;
    public static final int[] EV_YIELD = {0, 2, 0, 0, 0, 0};
    public static final int CAPTURE_RATE = 60;
    public static final double WEIGHT = 40.4;
    ...
    public static final int BASE_SPEED = 88;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/excadrill.png";
    public static final String BACK_PATH = "battle/backs/unova/excadrill.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/excadrill.png";
    public static final String CRY_PATH = "sounds/cry/530.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/excadrill.png";
