...
public class Espeon extends Pokemon {
    ...
    public static final String NAME = "Espeon";
    public static final String TYPE_OF_POKEMON = "Sun";
    public static final String DESCRIPTION = "Its fur is so sensitive, it can sense minute " +
            "shifts in the air and predict the weather.";
    public static final int BASE_EXP = 184;
    public static final int[] EV_YIELD = {0, 0, 0, 2, 0, 0};
    public static final int CAPTURE_RATE = 45;
    public static final double WEIGHT = 26.5;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/johto/espeon.png";
    public static final String BACK_PATH = "battle/backs/johto/espeon.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/johto/espeon.png";
    public static final String CRY_PATH = "sounds/cry/196.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/johto/espeon.png";
