...
public class Venomoth extends Pokemon {
    ...
    /**
     * Create a Venomoth with the specified level.
     * @param level The level of the Venomoth.
     */
    public Venomoth(int level) {
        super(NUMBER, NAME, level, Pokemon.Type.BUG, Pokemon.Type.POISON, Ability.SHIELD_DUST, ExpType.MEDIUM_FAST,
    ...
    /**
     * Create an Venomoth from the database.
     ...
     */
    public Venomoth(int level, int[] ivs, int [] evs, Skill firstSkill,
                   Skill secondSkill, Skill thirdSkill, Skill fourthSkill, int currentHealth, int currentExp,
                   Pokemon.Status status, Nature nature, Pokemon.Ability ability) {
        super(NUMBER, NAME, level, Pokemon.Type.BUG, Type.POISON, Ability.SHIELD_DUST, ExpType.MEDIUM_FAST,
                BASE_EXP, EV_YIELD, new int[]{BASE_HEALTH, BASE_ATTACK, BASE_DEFENSE,
                        BASE_SPECIAL_ATTACK, BASE_SPECIAL_DEFENSE, BASE_SPEED}, ICON_PATH,
                BACK_PATH, MINI_PATH, CRY_PATH, CAPTURE_RATE);
        initLevelUpSkills();
