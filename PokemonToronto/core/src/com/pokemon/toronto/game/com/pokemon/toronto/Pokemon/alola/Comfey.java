...
public class Comfey extends Pokemon {
    ...
    public static final String NAME = "Comfey";
    public static final String TYPE_OF_POKEMON = "Posy Picker";
    public static final String DESCRIPTION = "It attaches flowers to its highly nutritious vine." +
            " This revitalizes the flowers, and they give off an aromatic scent.";
    ...
    public static final Ability SECOND_ABILITY = new Ability.Triage();
    public static final Ability HIDDEN_ABILITY = new Ability.NaturalCure();

    //Base Stats
    public static final int BASE_HEALTH = 51;
    public static final int BASE_ATTACK = 52;
    public static final int BASE_DEFENSE = 90;
    public static final int BASE_SPECIAL_ATTACK = 82;
    public static final int BASE_SPECIAL_DEFENSE = 110;
    public static final int BASE_SPEED = 100;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/alola/comfey.png";
    public static final String BACK_PATH = "battle/backs/alola/comfey.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/alola/comfey.png";
    public static final String CRY_PATH = "sounds/cry/764.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/alola/comfey.png";
