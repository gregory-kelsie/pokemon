...
public class Zubat extends Pokemon {
    ...
    /**
     * Create a Zubat with the specified level.
     * @param level The level of the Zubat.
     */
    ...
    /**
     * Create an Zubat from the database.
     ...
     */
    public Zubat(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
