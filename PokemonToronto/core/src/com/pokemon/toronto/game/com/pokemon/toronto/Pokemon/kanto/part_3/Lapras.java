...
public class Lapras extends Pokemon {
    ...
    public Lapras(int level) {
        super(NUMBER, NAME, level, Pokemon.Type.WATER, Type.ICE, Ability.WATER_ABSORB, ExpType.SLOW,
    ...
    public Lapras(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
        ...
        super(NUMBER, NAME, level, gender, status, ivs, evs, Pokemon.Type.WATER, Type.ICE, ability, nature, ExpType.SLOW,
                BASE_EXP, EV_YIELD, new int[]{BASE_HEALTH, BASE_ATTACK, BASE_DEFENSE,
                        BASE_SPECIAL_ATTACK, BASE_SPECIAL_DEFENSE, BASE_SPEED}, ICON_PATH,
