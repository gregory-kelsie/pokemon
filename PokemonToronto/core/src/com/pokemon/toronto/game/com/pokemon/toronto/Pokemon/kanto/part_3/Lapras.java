...
public class Lapras extends Pokemon {
    ...
    public static final String NAME = "Lapras";
    public static final String TYPE_OF_POKEMON = "Transport";
    public static final String DESCRIPTION = "Its high intelligence enables it to understand" +
            " human speech. It likes to ferry people on its back.";

    public static final int BASE_EXP = 219;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/lapras.png";
    public static final String BACK_PATH = "battle/backs/lapras.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/lapras.png";
    public static final String CRY_PATH = "sounds/cry/131.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kanto/131.png";
