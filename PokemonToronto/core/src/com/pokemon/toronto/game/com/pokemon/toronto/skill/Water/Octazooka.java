...
public class Octazooka extends SecondaryEffectSkill {
    /**
     * - Name: Octazooka
     * - Type: Water
     * - Base Damage: 65
     ...
     */
    public Octazooka() {
        super(SkillFactory.OCTAZOOKA, "Octazooka", SkillDescription.OCTAZOOKA, 10,
                Pokemon.Type.WATER, Skill.SkillCategory.SPECIAL, 85, 65, 1, .5);
