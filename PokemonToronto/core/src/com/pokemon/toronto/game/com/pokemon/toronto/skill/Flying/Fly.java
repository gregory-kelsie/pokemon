...
public class Fly extends DamageSkill {
    /**
     * - Name: Fly
     * - Type: Flying
     * - Base Damage: 90
     ...
     */
    public Fly() {
        super(SkillFactory.FLY, "Fly", SkillDescription.FLY, 15, Pokemon.Type.FLYING,
                Skill.SkillCategory.PHYSICAL, 95, 90, 1);
    ...
    public List<String> use(Pokemon skillUser, Pokemon enemyPokemon, int skillUserPartyPosition,
        ...
        if (!skillUser.isFlying()) {
            ...
            results.add(skillUser.getName() + " flew\nup high!");
            return results;
        } else {
            skillUser.flyDown();
