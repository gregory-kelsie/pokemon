...
public class Golduck extends Pokemon {
    ...
    /**
     * Create a Golduck with the specified level.
     * @param level The level of the Golduck.
     */
    ...
    /**
     * Create an Golduck from the database.
     ...
     */
    public Golduck(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
