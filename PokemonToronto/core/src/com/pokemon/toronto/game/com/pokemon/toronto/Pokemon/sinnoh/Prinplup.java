...
public class Prinplup extends Pokemon {
    ...
    private static final int NUMBER = 394;
    private static final String NAME = "Prinplup";
    private static final int BASE_EXP = 142;
    private static final int[] EV_YIELD = {0, 0, 0, 2, 0, 0};
    private static final int CAPTURE_RATE = 45;
    private static final double WEIGHT = 23;
    ...
    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/sinnoh/prinplup.png";
    private static final String BACK_PATH = "battle/backs/sinnoh/prinplup.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/prinplup.png";
    private static final String CRY_PATH = "sounds/cry/394.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/prinplup.png";
