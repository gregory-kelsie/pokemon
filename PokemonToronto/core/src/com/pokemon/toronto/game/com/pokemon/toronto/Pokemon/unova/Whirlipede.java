...
public class Whirlipede extends Pokemon {
    ...
    private static final int NUMBER = 544;
    private static final String NAME = "Whirlipede";
    private static final int BASE_EXP = 126;
    private static final int[] EV_YIELD = {0, 0, 2, 0, 0, 0};
    private static final int CAPTURE_RATE = 120;
    private static final double WEIGHT = 58.5;
    ...
    private static final int BASE_DEFENSE = 99;
    private static final int BASE_SPECIAL_ATTACK = 40;
    private static final int BASE_SPECIAL_DEFENSE = 79;
    private static final int BASE_SPEED = 47;

    //Image Paths
    private static final String ICON_PATH = "pokemonSprites/unova/whirlipede.png";
    private static final String BACK_PATH = "battle/backs/unova/whirlipede.png";
    private static final String MINI_PATH = "pokemonMenu/sprites/unova/whirlipede.png";
    private static final String CRY_PATH = "sounds/cry/544.wav";
    private static final String PROFILE_PATH = "trainercard/pokemon/unova/whirlipede.png";
