...
public class Whirlipede extends Pokemon {
    ...
    public static final int NUMBER = 544;
    public static final String NAME = "Whirlipede";
    public static final String TYPE_OF_POKEMON = "Curlipede";
    public static final String DESCRIPTION = "Protected by a hard shell, it spins its body like " +
            "a wheel and crashes furiously into its enemies.";
    public static final double HEIGHT = 1.2;
    public static final int BASE_EXP = 126;
    public static final int[] EV_YIELD = {0, 0, 2, 0, 0, 0};
    public static final int CAPTURE_RATE = 120;
    public static final double WEIGHT = 58.5;
    ...
    public static final int BASE_DEFENSE = 99;
    public static final int BASE_SPECIAL_ATTACK = 40;
    public static final int BASE_SPECIAL_DEFENSE = 79;
    public static final int BASE_SPEED = 47;

    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/whirlipede.png";
    public static final String BACK_PATH = "battle/backs/unova/whirlipede.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/whirlipede.png";
    public static final String CRY_PATH = "sounds/cry/544.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/whirlipede.png";
    ...
    /**
     * Init whirlipede's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        levelUpSkills.put(37, new ArrayList<Integer>(Arrays.asList(SkillFactory.STEAMROLLER)));
        //41 TOXIC
        levelUpSkills.put(43, new ArrayList<Integer>(Arrays.asList(SkillFactory.VENOM_DRENCH)));
        levelUpSkills.put(46, new ArrayList<Integer>(Arrays.asList(SkillFactory.ROCK_CLIMB)));
    ...
    protected void initEvolutionSkills() {
        evolutionSkills.add(SkillFactory.IRON_DEFENSE);
    }
    ...
    /**
     * Return Scolipede if the Whirlipede is above level 30.
     * @return Scolipede if Whirlipede is the right level.
     */
    @Override
    public int getLevelUpEvolutionId() {
        if (level >= 30) {
            return PokemonId.SCOLIPEDE.getValue();
        }
        return -1;
    }
}
