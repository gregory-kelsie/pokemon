...
public class LightScreen extends Skill {
    /**
     * - Name: Light Screen
     * - Type: Psychic
     * - PP: 30
    ...
    /**
     * Use Light Screen and return the move results.
    ...
    public List<String> use(Pokemon skillUser, Pokemon enemyPokemon, int skillUserPartyPosition,
        ...
        results.add(skillUser.getName() + "'s team\nhas increased Special Defense!");
        userField.activateLightScreen();
        return results;
    }

    /**
     * Return Light Screen's skill animation.
