...
public class Turtwig extends Pokemon {
    ...
    public static final int NUMBER = 387;
    public static final String NAME = "Turtwig";
    public static final String TYPE_OF_POKEMON = "Tiny Leaf";
    public static final String DESCRIPTION = "The shell on its back is made of soil. On a very" +
            " healthy Turtwig, the shell should feel moist.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/sinnoh/turtwig.png";
    public static final String BACK_PATH = "battle/backs/sinnoh/turtwig.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/sinnoh/turtwig.png";
    public static final String CRY_PATH = "sounds/cry/387.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/sinnoh/turtwig.png";
