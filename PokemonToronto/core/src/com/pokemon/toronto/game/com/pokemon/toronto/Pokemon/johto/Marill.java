...
public class Marill extends Pokemon {
    ...
    public static final String NAME = "Marill";
    public static final String TYPE_OF_POKEMON = "Aquamouse";
    public static final String DESCRIPTION = "The oil-filled tail functions as a buoy, so it's" +
            " fine even in rivers with strong currents.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/johto/marill.png";
    public static final String BACK_PATH = "battle/backs/johto/marill.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/johto/marill.png";
    public static final String CRY_PATH = "sounds/cry/183.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/johto/marill.png";
