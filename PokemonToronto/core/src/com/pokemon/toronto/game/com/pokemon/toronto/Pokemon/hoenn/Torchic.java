...
public class Torchic extends Pokemon {
    ...
    public static final int NUMBER = 255;
    public static final String NAME = "Torchic";
    public static final String TYPE_OF_POKEMON = "Chick";
    public static final String DESCRIPTION = "A fire burns inside, so it feels very warm to" +
            " hug. It launches fireballs of 1,800 degrees F.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/torchic.png";
    public static final String BACK_PATH = "battle/backs/hoenn/torchic.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/torchic.png";
    public static final String CRY_PATH = "sounds/cry/255.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/torchic.png";
    ...
    /**
     * Init torchic's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        levelUpSkills.put(19, new ArrayList<Integer>(Arrays.asList(SkillFactory.FIRE_SPIN)));
        levelUpSkills.put(23, new ArrayList<Integer>(Arrays.asList(SkillFactory.QUICK_ATTACK)));
    ...
    /**
     * Return Combusken if the torchic is above level 16.
     * @return Combusken if torchic is the right level.
     */
    @Override
    public int getLevelUpEvolutionId() {
        if (level >= 16) {
            return PokemonId.COMBUSKEN.getValue();
        }
        return -1;
    }
}
