...
public class Tangela extends Pokemon {
    ...
    public Tangela(int level) {
        super(NUMBER, NAME, level, Type.GRASS, Type.NONE, Ability.CHLOROPHYLL, ExpType.MEDIUM_FAST,
    ...
    public Tangela(boolean fromDatabase, int level, char gender, int[] ivs, int [] evs, Skill firstSkill,
        ...
        super(NUMBER, NAME, level, gender, status, ivs, evs, Type.GRASS, Type.NONE, ability, nature, ExpType.MEDIUM_FAST,
                BASE_EXP, EV_YIELD, new int[]{BASE_HEALTH, BASE_ATTACK, BASE_DEFENSE,
                        BASE_SPECIAL_ATTACK, BASE_SPECIAL_DEFENSE, BASE_SPEED}, ICON_PATH,
