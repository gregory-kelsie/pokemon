...
public class Gothitelle extends Pokemon {
    ...
    public static final int NUMBER = 576;
    public static final String NAME = "Gothitelle";
    public static final String TYPE_OF_POKEMON = "Astral Body";
    public static final String DESCRIPTION = "They can predict the future from the placement" +
            " and movement of the stars. They can see Trainers' life spans.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/unova/gothitelle.png";
    public static final String BACK_PATH = "battle/backs/unova/gothitelle.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/unova/gothitelle.png";
    public static final String CRY_PATH = "sounds/cry/576.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/unova/gothitelle.png";
