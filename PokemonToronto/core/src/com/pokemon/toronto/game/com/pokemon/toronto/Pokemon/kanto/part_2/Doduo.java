...
public class Doduo extends Pokemon {
    ...
    public static final String NAME = "Doduo";
    public static final String TYPE_OF_POKEMON = "Twin Bird";
    public static final String DESCRIPTION = "A two-headed Pokémon that was discovered as a" +
            " sudden mutation. It runs at a pace of over 60 miles per hour.";

    public static final int BASE_EXP = 96;
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/doduo.png";
    public static final String BACK_PATH = "battle/backs/doduo.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/doduo.png";
    public static final String CRY_PATH = "sounds/cry/084.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/kanto/084.png";
