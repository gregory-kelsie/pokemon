...
public class Claydol extends Pokemon {
    ...
    public static final int NUMBER = 344;
    public static final String NAME = "Claydol";
    public static final String TYPE_OF_POKEMON = "Clay Doll";
    public static final String DESCRIPTION = "An ancient clay figurine that came to life as a" +
            " Pokémon from exposure to a mysterious ray of light.";
    ...
    //Image Paths
    public static final String ICON_PATH = "pokemonSprites/hoenn/claydol.png";
    public static final String BACK_PATH = "battle/backs/hoenn/claydol.png";
    public static final String MINI_PATH = "pokemonMenu/sprites/hoenn/claydol.png";
    public static final String CRY_PATH = "sounds/cry/344.wav";
    public static final String PROFILE_PATH = "trainercard/pokemon/hoenn/claydol.png";
    ...
    /**
     * Init claydol's level up skills.
     */
    @Override
    protected void initLevelUpSkills() {
        ...
        //34 GUARD SPLIT
        //34 POWER SPLIT
        levelUpSkills.put(40, new ArrayList<Integer>(Arrays.asList(SkillFactory.EARTH_POWER)));
        levelUpSkills.put(46, new ArrayList<Integer>(Arrays.asList(SkillFactory.SANDSTORM)));
        //52 IMPRISON
        levelUpSkills.put(58, new ArrayList<Integer>(Arrays.asList(SkillFactory.EXPLOSION)));
        initEvolutionSkills();
    }

    protected void initEvolutionSkills() {
        evolutionSkills.add(SkillFactory.HYPER_BEAM);
    }
